...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Задача с id=1 " + taskManager.getTaskById(1));
        System.out.println("Задача с id=2 " + taskManager.getTaskById(2));
        ...
        */
        ...
        System.out.println("Подзадача с id=4 " + taskManager.getTaskById(4));
        System.out.println("Подзадача с id=5 " + taskManager.getTaskById(5));
        System.out.println("Эпик с id=3 " + taskManager.getTaskById(3));
        ...
        */
        ...
        System.out.println("Подзадача с id=7 " + taskManager.getTaskById(7));
        System.out.println("Эпик с id=6 " + taskManager.getTaskById(6));
